...
function Purchases() {
  ...
  useEffect(() => {
    const fetchPurchases = async () => {
      try {
        ...
        setPurchase(response.data.notesData);
      } catch (error) {
  ...
  return (
    <div className="flex h-screen">
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 bg-gray-400 p-5 transform ${
      ...
      >
        <nav>
          <ul className="mt-16 md:mt-0">
            ...
            <li className="mb-4">
              <a href="/purchases" className="flex items-center text-gray-200">
      ...
      <button
        className="fixed top-4 left-4 z-50 md:hidden bg-gray-200 text-white p-2 rounded-lg"
              ...
              >
                <div className="flex flex-col items-center space-y-4">
                  ...
                  <div className="text-center">
                    <h3 className="text-xl font-bold">{purchase.title}</h3>
