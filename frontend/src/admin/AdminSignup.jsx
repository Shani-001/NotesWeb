      ...
      <div className="h-screen container mx-auto flex  items-center justify-center text-white">
        ...
        <header className="absolute top-0 left-0 w-full flex justify-between items-center p-5  ">
          ...
          <div className="flex items-center space-x-4">
            <Link
              to={"/admin/login"}
              className="bg-transparent border border-gray-500 py-2 px-4 rounded-md z-20"
            >
              Login
            </Link>
            <Link
              to={"/notes"}
              className="bg-purple-500 py-2 px-4 rounded-md z-20"
            >
              Join now
            </Link>
          </div>
        ...
        {/* AdminSignup Form */}
        <div className="bg-gray-900 p-8 rounded-lg shadow-lg w-[500px] mt-20 z-20">
